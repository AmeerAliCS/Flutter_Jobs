...
class JobPageAdmin extends StatefulWidget {

  final collectoinName;

  JobPageAdmin({this.collectoinName});

  @override
  _JobPageAdminState createState() => _JobPageAdminState();
}

class _JobPageAdminState extends State<JobPageAdmin> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          Navigator.of(context).push(MaterialPageRoute(builder: (context) => AddData(collection: widget.collectoinName)));
        },
